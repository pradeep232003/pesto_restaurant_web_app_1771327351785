...
from routes.acidity import router as acidity_router
from routes.vacuum_packing import router as vacuum_packing_router
from routes.food_washing import router as food_washing_router
...
app.include_router(acidity_router)
app.include_router(vacuum_packing_router)
app.include_router(food_washing_router)
