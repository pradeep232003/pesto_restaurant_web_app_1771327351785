  ...
  return (
    <div className="pb-8" data-testid="jkhive-routines">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Tile testId="tile-opening-routine"     to="/jkhive/daily-checks"      icon={Sunrise}     color="#FF9500" title="Opening Routine"    subtitle="Pre-service checks" />
        <Tile testId="tile-closing-routine"     to="/jkhive/kitchen-closedown" icon={Sunset}      color="#5856D6" title="Closing Routine"    subtitle="End-of-day shutdown" />
