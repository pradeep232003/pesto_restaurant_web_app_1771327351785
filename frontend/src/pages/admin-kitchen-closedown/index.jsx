...
const AdminKitchenClosedown = () => {
  ...
  return (
    <div className={isJkhive ? "px-4 sm:px-6 lg:px-8 pt-2 pb-32 max-w-5xl mx-auto" : "p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto"} data-testid="admin-kitchen-closedown-page">
      {isJkhive ? (
        <Link to="/jkhive/routines" data-testid="back-to-jkhive" className="inline-flex items-center gap-1.5 -ml-1 px-1 py-1 mb-1 rounded-lg active:scale-95" style={{ color: '#1D1D1F', ...font }}>
          ...
          <span className="text-xl sm:text-2xl font-semibold tracking-tight">Kitchen Closedown</span>
        </Link>
      ) : (
