...
import { UtensilsCrossed, ClipboardList, ClipboardCheck, Store, Plus, Settings, ArrowUpRight, ArrowRight, Thermometer, DollarSign, Power, Flame, Truck, Gauge, Droplet, Sparkles, Shield, MapPin, Check } from 'lucide-react';
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <Link
          to="/jkhive"
          data-testid="open-jkhive-btn"
          className="flex items-center gap-2 px-4 py-2.5 rounded-2xl text-sm font-semibold whitespace-nowrap active:scale-95 transition-all shadow-sm"
          style={{ background: 'linear-gradient(135deg, #1D1D1F 0%, #3A3A3C 100%)', color: '#FFFFFF', fontFamily: 'Outfit, sans-serif' }}
        >
          <span style={{ background: 'linear-gradient(135deg,#FF9500,#FF2D55)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 700 }}>JKHive</span>
